...
export const calculateAttritionRisk = async (organizationId: string, employeeId: string): Promise<AttritionRiskResult> => {
    ...
    let level: AttritionRiskResult['level'] = 'LOW';
...
export const getRiskProfile = async (organizationId: string, employeeId: string) => {
    const attrition = await calculateAttritionRisk(organizationId, employeeId);
