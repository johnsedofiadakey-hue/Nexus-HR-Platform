import{q as ee,n as te,p as J,r as h,v as Je,w as et,x as Xn,y as Qn,z as _,C as en,D as tn,E as Zn,F as ei,G as w,H as ti,I as ni,J as de,K as ii,L as tt,M as nt,O as ri,P as nn,Q as si,R as oi,U as ai,V as ci,W as bt,X as Nt,Y as Ot,Z as li}from"./index-Dc20QQfA.js";import"./vendor-ui-DnKctv17.js";import"./vendor-react-DO8fZQJQ.js";import"./vendor-utils--tPgiDxl.js";function it(n,e){var t={};for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&e.indexOf(i)<0&&(t[i]=n[i]);if(n!=null&&typeof Object.getOwnPropertySymbols=="function")for(var r=0,i=Object.getOwnPropertySymbols(n);r<i.length;r++)e.indexOf(i[r])<0&&Object.prototype.propertyIsEnumerable.call(n,i[r])&&(t[i[r]]=n[i[r]]);return t}/**
 * @license
 ...
 */const ao={PHONE:"phone",TOTP:"totp"},co={FACEBOOK:"facebook.com",GITHUB:"github.com",GOOGLE:"google.com",PASSWORD:"password",PHONE:"phone",TWITTER:"twitter.com"},lo={EMAIL_LINK:"emailLink",EMAIL_PASSWORD:"password",FACEBOOK:"facebook.com",GITHUB:"github.com",GOOGLE:"google.com",PHONE:"phone",TWITTER:"twitter.com"},uo={LINK:"link",REAUTHENTICATE:"reauthenticate",SIGN_IN:"signIn"},ho={EMAIL_SIGNIN:"EMAIL_SIGNIN",PASSWORD_RESET:"PASSWORD_RESET",RECOVER_EMAIL:"RECOVER_EMAIL",REVERT_SECOND_FACTOR_ADDITION:"REVERT_SECOND_FACTOR_ADDITION",VERIFY_AND_CHANGE_EMAIL:"VERIFY_AND_CHANGE_EMAIL",VERIFY_EMAIL:"VERIFY_EMAIL"};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ae(n){var e;const t=n.auth,i=await n.getIdToken(),r=await O(n,ke(t,{idToken:i}));l(r==null?void 0:r.users.length,t,"internal-error");const s=r.users[0];n._notifyReloadListener(s);const o=!((e=s.providerUserInfo)===null||e===void 0)&&e.length?dn(s.providerUserInfo):[],a=ki(n.providerData,o),c=n.isAnonymous,u=!(n.email&&s.passwordHash)&&!(a!=null&&a.length),d=c?u:!1,p={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:a,metadata:new Xe(s.createdAt,s.lastLoginAt),isAnonymous:d};Object.assign(n,p)}async function Pi(n){const e=h(n);await ae(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function ki(n,e){return[...n.filter(i=>!e.some(r=>r.providerId===i.providerId)),...e]}function dn(n){return n.map(e=>{var{providerId:t}=e,i=it(e,["providerId"]);return{providerId:t,uid:i.rawId||"",displayName:i.displayName||null,email:i.email||null,phoneNumber:i.phoneNumber||null,photoURL:i.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mr(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function gr(n){const e=ee(te(n)).link,t=e?ee(te(e)).deep_link_id:null,i=ee(te(n)).deep_link_id;return(i?ee(te(i)).link:null)||i||t||e||n}class me{constructor(e){var t,i,r,s,o,a;const c=ee(te(e)),u=(t=c.apiKey)!==null&&t!==void 0?t:null,d=(i=c.oobCode)!==null&&i!==void 0?i:null,p=mr((r=c.mode)!==null&&r!==void 0?r:null);l(u&&d&&p,"argument-error"),this.apiKey=u,this.operation=p,this.code=d,this.continueUrl=(s=c.continueUrl)!==null&&s!==void 0?s:null,this.languageCode=(o=c.lang)!==null&&o!==void 0?o:null,this.tenantId=(a=c.tenantId)!==null&&a!==void 0?a:null}static parseLink(e){const t=gr(e);try{return new me(t)}catch{return null}}}function go(n){return me.parseLink(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Io(n,e){const t=h(n);await De(!0,t,e);const{providerUserInfo:i}=await yi(t.auth,{idToken:await t.getIdToken(),deleteProvider:[e]}),r=bn(i||[]);return t.providerData=t.providerData.filter(s=>r.has(s.providerId)),r.has("phone")||(t.phoneNumber=null),await t.auth._persistUserIfCurrent(t),t}async function ut(n,e,t=!1){const i=await O(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return A._forOperation(n,"link",i)}async function De(n,e,t){await ae(e);const i=bn(e.providerData),r=n===!1?"provider-already-linked":"no-such-provider";l(i.has(t)===n,e.auth,r)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function vo(n,e){if(_(n.app))return Promise.reject(E(n));const t=I(n),i=await Tr(t,{token:e,returnSecureToken:!0}),r=await A._fromIdTokenResponse(t,"signIn",i);return await t._updateCurrentUser(r.user),r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ft(n){const e=I(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function Eo(n,e,t){const i=I(n),r={requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"};t&&Le(i,r,t),await H(i,r,"getOobCode",sr,"EMAIL_PASSWORD_PROVIDER")}async function To(n,e,t){await Pn(h(n),{oobCode:e,newPassword:t}).catch(async i=>{throw i.code==="auth/password-does-not-meet-requirements"&&ft(n),i})}async function yo(n,e){await nr(h(n),{oobCode:e})}async function yr(n,e){const t=h(n),i=await Pn(t,{oobCode:e}),r=i.requestType;switch(l(r,t,"internal-error"),r){case"EMAIL_SIGNIN":break;case"VERIFY_AND_CHANGE_EMAIL":l(i.newEmail,t,"internal-error");break;case"REVERT_SECOND_FACTOR_ADDITION":l(i.mfaInfo,t,"internal-error");default:l(i.email,t,"internal-error")}let s=null;return i.mfaInfo&&(s=ge._fromServerResponse(I(t),i.mfaInfo)),{data:{email:(i.requestType==="VERIFY_AND_CHANGE_EMAIL"?i.newEmail:i.email)||null,previousEmail:(i.requestType==="VERIFY_AND_CHANGE_EMAIL"?i.email:i.newEmail)||null,multiFactorInfo:s},operation:r}}async function wo(n,e){const{data:t}=await yr(h(n),e);return t.email}async function Ao(n,e,t){if(_(n.app))return Promise.reject(E(n));const i=I(n),o=await H(i,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",kn,"EMAIL_PASSWORD_PROVIDER").catch(c=>{throw c.code==="auth/password-does-not-meet-requirements"&&ft(n),c}),a=await A._fromIdTokenResponse(i,"signIn",o);return await i._updateCurrentUser(a.user),a}function Ro(n,e,t){return _(n.app)?Promise.reject(E(n)):dt(h(n),j.credential(e,t)).catch(async i=>{throw i.code==="auth/password-does-not-meet-requirements"&&ft(n),i})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Po(n,e,t){const i=I(n),r={requestType:"EMAIL_SIGNIN",email:e,clientType:"CLIENT_TYPE_WEB"};function s(o,a){l(a.handleCodeInApp,i,"argument-error"),a&&Le(i,o,a)}s(r,t),await H(i,r,"getOobCode",or,"EMAIL_PASSWORD_PROVIDER")}function ko(n,e){const t=me.parseLink(e);return(t==null?void 0:t.operation)==="EMAIL_SIGNIN"}async function So(n,e,t){if(_(n.app))return Promise.reject(E(n));const i=h(n),r=j.credentialWithLink(e,t||oe());return l(r._tenantId===(i.tenantId||null),i,"tenant-id-mismatch"),dt(i,r)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function bo(n,e){const t=ot()?oe():"http://localhost",i={identifier:e,continueUri:t},{signinMethods:r}=await wr(h(n),i);return r||[]}async function No(n,e){const t=h(n),r={requestType:"VERIFY_EMAIL",idToken:await n.getIdToken()};e&&Le(t.auth,r,e);const{email:s}=await rr(t.auth,r);s!==n.email&&await n.reload()}async function Oo(n,e,t){const i=h(n),s={requestType:"VERIFY_AND_CHANGE_EMAIL",idToken:await n.getIdToken(),newEmail:e};t&&Le(i.auth,s,t);const{email:o}=await ar(i.auth,s);o!==n.email&&await n.reload()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Co(n,{displayName:e,photoURL:t}){if(e===void 0&&t===void 0)return;const i=h(n),s={idToken:await i.getIdToken(),displayName:e,photoUrl:t,returnSecureToken:!0},o=await O(i,Ar(i.auth,s));i.displayName=o.displayName||null,i.photoURL=o.photoUrl||null;const a=i.providerData.find(({providerId:c})=>c==="password");a&&(a.displayName=i.displayName,a.photoURL=i.photoURL),await i._updateTokensIfNecessary(o)}function Do(n,e){const t=h(n);return _(t.auth.app)?Promise.reject(E(t.auth)):Cn(t,e,null)}function Lo(n,e){return Cn(h(n),null,e)}async function Cn(n,e,t){const{auth:i}=n,s={idToken:await n.getIdToken(),returnSecureToken:!0};e&&(s.email=e),t&&(s.password=t);const o=await O(n,er(i,s));await n._updateTokensIfNecessary(o,!0)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rr(n){var e,t;if(!n)return null;const{providerId:i}=n,r=n.rawUserInfo?JSON.parse(n.rawUserInfo):{},s=n.isNewUser||n.kind==="identitytoolkit#SignupNewUserResponse";if(!i&&(n!=null&&n.idToken)){const o=(t=(e=Oe(n.idToken))===null||e===void 0?void 0:e.firebase)===null||t===void 0?void 0:t.sign_in_provider;if(o){const a=o!=="anonymous"&&o!=="custom"?o:null;return new B(s,a)}}if(!i)return null;switch(i){case"facebook.com":return new Pr(s,r);case"github.com":return new kr(s,r);case"google.com":return new Sr(s,r);case"twitter.com":return new br(s,r,n.screenName||null);case"custom":case"anonymous":return new B(s,null);default:return new B(s,i,r)}}class B{constructor(e,t,i={}){this.isNewUser=e,this.providerId=t,this.profile=i}}class Dn extends B{constructor(e,t,i,r){super(e,t,i),this.username=r}}class Pr extends B{constructor(e,t){super(e,"facebook.com",t)}}class kr extends Dn{constructor(e,t){super(e,"github.com",t,typeof(t==null?void 0:t.login)=="string"?t==null?void 0:t.login:null)}}class Sr extends B{constructor(e,t){super(e,"google.com",t)}}class br extends Dn{constructor(e,t,i){super(e,"twitter.com",t,i)}}function Mo(n){const{user:e,_tokenResponse:t}=n;return e.isAnonymous&&!t?{providerId:null,isNewUser:!1,profile:null}:Rr(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Uo(n,e){return h(n).setPersistence(e)}function Vo(n){return An(n)}async function Fo(n,e){return I(n).validatePassword(e)}function Nr(n,e,t,i){return h(n).onIdTokenChanged(e,t,i)}function Or(n,e,t){return h(n).beforeAuthStateChanged(e,t)}function xo(n,e,t,i){return h(n).onAuthStateChanged(e,t,i)}function Ho(n){h(n).useDeviceLanguage()}function Wo(n,e){return h(n).updateCurrentUser(e)}function qo(n){return h(n).signOut()}function jo(n,e){return I(n).revokeAccessToken(e)}async function Go(n){return h(n).delete()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function na(n,e,t){return fs(n,e,t)}async function fs(n,e,t){if(_(n.app))return Promise.reject(E(n));const i=I(n);X(n,e,L),await i._initializationPromise;const r=G(i,t);return await Et(r,i),r._openRedirect(i,e,"signInViaRedirect")}function ia(n,e,t){return ms(n,e,t)}async function ms(n,e,t){const i=h(n);if(X(i.auth,e,L),_(i.auth.app))return Promise.reject(E(i.auth));await i.auth._initializationPromise;const r=G(i.auth,t);await Et(r,i.auth);const s=await Kn(i);return r._openRedirect(i.auth,e,"reauthViaRedirect",s)}function ra(n,e,t){return gs(n,e,t)}async function gs(n,e,t){const i=h(n);X(i.auth,e,L),await i.auth._initializationPromise;const r=G(i.auth,t);await De(!1,i,e.providerId),await Et(r,i.auth);const s=await Kn(i);return r._openRedirect(i.auth,e,"linkViaRedirect",s)}async function sa(n,e){return await I(n)._initializationPromise,zn(n,e,!1)}async function zn(n,e,t=!1){if(_(n.app))return Promise.reject(E(n));const i=I(n),r=G(i,e),o=await new ds(i,r,t).execute();return o&&!t&&(delete o.user._redirectEventId,await i._persistUserIfCurrent(o.user),await i._setRedirectUser(null,e)),o}async function Kn(n){const e=Ue(`${n.uid}:::`);return n._redirectEventId=e,await n.auth._setRedirectUser(n),await n.auth._persistUserIfCurrent(n),e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zs=5*60,eo=tn("authIdTokenMaxAge")||Zs;let Zt=null;const to=n=>async e=>{const t=e&&await e.getIdTokenResult(),i=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(i&&i>eo)return;const r=t==null?void 0:t.token;Zt!==r&&(Zt=r,await fetch(n,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))};function oa(n=ei()){const e=en(n,"auth");if(e.isInitialized())return e.getImmediate();const t=Yi(n,{popupRedirectResolver:$s,persistence:[Xr,Fr,Fn]}),i=tn("authTokenSyncURL");if(i&&typeof isSecureContext=="boolean"&&isSecureContext){const s=new URL(i,location.origin);if(location.origin===s.origin){const o=to(s.toString());Or(t,o,()=>o(t.currentUser)),Nr(t,a=>o(a))}}const r=Zn("auth");return r&&Xi(t,`http://${r}`),t}function no(){var n,e;return(e=(n=document.getElementsByTagName("head"))===null||n===void 0?void 0:n[0])!==null&&e!==void 0?e:document}Vi({loadJS(n){return new Promise((e,t)=>{const i=document.createElement("script");i.setAttribute("src",n),i.onload=e,i.onerror=r=>{const s=T("internal-error");s.customData=r,t(s)},i.type="text/javascript",i.charset="UTF-8",no().appendChild(i)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});Qs("Browser");export{ho as ActionCodeOperation,me as ActionCodeURL,fe as AuthCredential,fo as AuthErrorCodes,ce as EmailAuthCredential,j as EmailAuthProvider,U as FacebookAuthProvider,ao as FactorId,F as GithubAuthProvider,V as GoogleAuthProvider,C as OAuthCredential,we as OAuthProvider,uo as OperationType,q as PhoneAuthCredential,Y as PhoneAuthProvider,Bs as PhoneMultiFactorGenerator,co as ProviderId,Bo as RecaptchaVerifier,Qe as SAMLAuthProvider,lo as SignInMethod,Ys as TotpMultiFactorGenerator,yt as TotpSecret,x as TwitterAuthProvider,yo as applyActionCode,Or as beforeAuthStateChanged,$o as browserCookiePersistence,Fr as browserLocalPersistence,$s as browserPopupRedirectResolver,Fn as browserSessionPersistence,yr as checkActionCode,To as confirmPasswordReset,Xi as connectAuthEmulator,Ao as createUserWithEmailAndPassword,po as debugErrorMap,Go as deleteUser,bo as fetchSignInMethodsForEmail,Mo as getAdditionalUserInfo,oa as getAuth,mo as getIdToken,wi as getIdTokenResult,zo as getMultiFactorResolver,sa as getRedirectResult,Vt as inMemoryPersistence,Xr as indexedDBLocalPersistence,Yi as initializeAuth,Vo as initializeRecaptchaConfig,ko as isSignInWithEmailLink,vr as linkWithCredential,Jo as linkWithPhoneNumber,ta as linkWithPopup,ra as linkWithRedirect,Ko as multiFactor,xo as onAuthStateChanged,Nr as onIdTokenChanged,go as parseActionCodeURL,di as prodErrorMap,Er as reauthenticateWithCredential,Xo as reauthenticateWithPhoneNumber,ea as reauthenticateWithPopup,ia as reauthenticateWithRedirect,Pi as reload,jo as revokeAccessToken,No as sendEmailVerification,Eo as sendPasswordResetEmail,Po as sendSignInLinkToEmail,Uo as setPersistence,_o as signInAnonymously,dt as signInWithCredential,vo as signInWithCustomToken,Ro as signInWithEmailAndPassword,So as signInWithEmailLink,Yo as signInWithPhoneNumber,Zo as signInWithPopup,na as signInWithRedirect,qo as signOut,Io as unlink,Wo as updateCurrentUser,Do as updateEmail,Lo as updatePassword,Qo as updatePhoneNumber,Co as updateProfile,Ho as useDeviceLanguage,Fo as validatePassword,Oo as verifyBeforeUpdateEmail,wo as verifyPasswordResetCode};
