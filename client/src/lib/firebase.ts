...
const firebaseConfig = {
  ...
  authDomain: config.authDomain || "nexus-hr-platform.firebaseapp.com",
  projectId: config.projectId || "nexus-hr-platform",
  storageBucket: config.storageBucket || "nexus-hr-platform.firebasestorage.app",
